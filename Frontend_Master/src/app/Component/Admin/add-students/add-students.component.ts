...
export class AddStudentsComponent  implements OnInit {
  ...
  data_length: string = localStorage.getItem("add_student_details") ? JSON.parse(localStorage.getItem("add_student_details")||'[]').length : 0;
  ...
  GetData(){
    ...
    axios.get(`${environment.apiURL}/student/show/uniqueByStudentCode`,{
      headers: {
  ...
  GetDataById(id:number){
    console.log()
    const token = localStorage.getItem('jwtToken');
    axios.get(`${environment.apiURL}/student/show/${id}`,{
      headers: {
        Authorization: `Bearer ${token}`,
        'Access-Control-Allow-Origin': '*',
        'Access-Control-Allow-Headers': '*',
  ...
  this.field1Value = this.ApiDataById.studentCode;
  this.field2Value = this.ApiDataById.studentName;
  this.field3Value = this.ApiDataById.studentEmail;
  ...
  submitTableData() {
    ...
    if (this.isdata_deleted) {
      const postData={
        studentCode: this.field1Value,
        studentName:this.field2Value,
        studentEmail: this.field3Value,
       
        };
        const token = localStorage.getItem('jwtToken');
        axios
      .post(`${environment.apiURL}/student/update/${this.indexNumber}`, postData,{
        headers: {
          Authorization: `Bearer ${token}`,
          'Access-Control-Allow-Origin': '*',
          'Access-Control-Allow-Headers': '*',
      ...
      const postData={
        ...
        const token = localStorage.getItem('jwtToken');
        axios
      .post(`${environment.apiURL}/student/add`, postData,{
        headers: {
          Authorization: `Bearer ${token}`,
          'Access-Control-Allow-Origin': '*',
          'Access-Control-Allow-Headers': '*',
  ...
  //       const token = localStorage.getItem('jwtToken');
  //       axios
  //         .post(`${environment.apiURL}/student/delete/${indexNumber}`,{
  //           headers: {
  //             Authorization: `Bearer ${token}`,
  //             'Access-Control-Allow-Origin': '*',
  //             'Access-Control-Allow-Headers': '*',
  ...
  deleteItem(indexNumber: number) {
    ...
    `,
      ...
      if (result.isConfirmed) {
        ...
        axios
          .post(`${environment.apiURL}/student/delete/${indexNumber}`, null, config) // Pass null as the request payload
          .then((response) => {
            console.log(response);
            Swal.fire('Deleted!', 'Your item has been deleted.', 'success');
            this.GetData();
